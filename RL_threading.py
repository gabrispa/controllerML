import sys
sys.path.insert(0,'/home/gabriele/controllerRL/RoutingGeant')
...
def get_paths_base():
    file_base = '/home/gabriele/controllerRL/RoutingGeant/paths_weight.json'
...
def get_paths_RL():
    file_RL = '/home/gabriele/controllerRL/paths.json'
...
def calc_all_stretch(cont):
    ...
    a = time.time()
    with open('/home/gabriele/controllerRL/RoutingGeant/stretch/stretch.csv','w') as csvfile:
...
def RL_thread():
    ...
    # while cont < 30:
        a = time.time()
        data = pd.read_csv("/home/gabriele/controllerRL/net_info.csv")
